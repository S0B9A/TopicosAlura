package com.Arias.foro_alura.controller;
...
public class UsuarioController {
    ...
    @Autowired
    private com.gep.foro_alura.domain.usuario.UsuarioRepository repository;
    ...
    public ResponseEntity<com.gep.foro_alura.domain.usuario.DetallesUsuarioDTO> crearUsuario(@RequestBody @Valid CrearUsuarioDTO crearUsuarioDTO, UriComponentsBuilder uriBuilder){
        crearValidador.forEach(v -> v.validate(crearUsuarioDTO));

        String hashedPassword = passwordEncoder.encode(crearUsuarioDTO.password());
        com.gep.foro_alura.domain.usuario.Usuario usuario = new com.gep.foro_alura.domain.usuario.Usuario(crearUsuarioDTO, hashedPassword);
